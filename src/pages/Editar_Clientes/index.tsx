    ...
    <body>
        ...
        <div className="edit">
                ...
                <div className="row g-2">
                    ...
                    <div className="col-md">        
                        <div className="form-floating">
                            <select className="form-control" aria-label="Disabled select example"  disabled={isDisabled} onChange={handleSelect} name="status" value={cliente?.status}>
